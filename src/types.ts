export enum OrderStatus {
  ...
  COMPLETED = 'completed', // Result: order completed (retry impossible)
}
...
export enum OrderLegStatus {
  ...
  COMPLETED = 'completed', // Result: provider order completed (retry impossible)
}

export enum OrderStatusShort {
  pending = 'pending',
  sending = 'sending',
  monitoring = 'monitoring',
  expired = 'expired',
...
export enum OrderLegStatusShort {
  waiting = 'waiting',
  pending = 'pending',
  sending = 'sending',
...
// getAssetDepositLimits (GET /assets/limits/)
...
// createAndFetchQuote (POST /quotes/, GET /quotes/{id})
...
// createAndFetchOrder (POST /orders/, GET /orders/{id})
...
// createAndFetchOrder (GET /orders/{id})
